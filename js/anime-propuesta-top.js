...
new ScrollMagic.Scene({
    triggerElement: "#animacion-propuesta-bottom",
    duration: "100%",
    triggerHook: 0.9
})
.setAnime(lineas)
...
var rectBottomRight = anime({
  targets: '.rectBottomRight',
  strokeDashoffset: [anime.setDashoffset, 0],
  easing: "easeInQuad",
  duration: 4500,
...
.setAnime(rectBottomRight)

.addTo(controller);


/********** CIRCULO BOTTTOM *****/
var circuloVerdeBottomNuestraPropuesta = anime({
  targets: '.circulo-verde-bottom-nuestraPropuesta',
  scale: [ .5, 1.5],
  easing: "easeInQuad", /* 'easeOutElastic(1, .8)' */
  duration: 1200,
...
.setAnime(circuloVerdeBottomNuestraPropuesta)
